...
Refinery::Images.configure do |config|
  ...
  config.dragonfly_secret = "8902c7d1847088882974be6b4491f1e4a966c4c3d1c643ad"
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Volumes/inertialbox/hack/refinery-rails-5-sprockets-issue-3178/public/system/refinery/images"
